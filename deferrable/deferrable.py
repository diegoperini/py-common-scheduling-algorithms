...
if __name__ == '__main__':
    ...
    for i in xrange(0, hyperperiod, clock_step):
            ...
            if on_cpu.name == "Deferrable":
                ...
                if on_def is not None:
                    ...
                    if on_cpu.consume(clock_step):
                        ...
                        html += '<div style="float: left; text-align: center; width: 110px; height: 20px; background-color:' + html_color[on_cpu.name] + ';">' + on_def.get_unique_name() + '<br />' + str(i) + '-' + str(i+1) + '</div>'
        ...
        #Cpu is idle
            ...
            html += '<div style="float: left; text-align: center; width: 110px; height: 20px; background-color:' + html_color['Empty'] + ';">Empty' + '<br />' + str(i) + '-' + str(i+1) + '</br></div>'
